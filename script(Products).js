...
p4.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/latte_coffee.jpg";
...
p5.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/vanilla_latte.jpg";
...
p8.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/cold_brew.jpg";
...
p12.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/Moroccain_Tea.jpg";
...
p15.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/NeSpresso_Capsules.jpg";
...
p17.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/pact_coffee.jpg";
...
p18.addEventListener("click", () => {
  PDS.classList.add("active");
  mainImg.src = "imag/Tea_Mushrooms.jpg";
